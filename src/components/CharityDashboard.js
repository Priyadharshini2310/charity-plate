...
const CharityDashboard = () => {
  ...
  const processAnalyticsData = () => {
    ...
    donations.forEach(donation => {
      const month = new Date(donation.createdAt).toLocaleDateString('en-US', { month: 'short', year: '2-digit' });
  ...
  const fetchSentMessages = async () => {
    try {
      ...
      if (!charityResponse.ok || !charityData?.data?._id) {
              ...
              <div className="relative">
                ...
                {showProfileDropdown && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                    ...
                    >
                      <IoHeart className="w-4 h-4 text-indigo-600" />
                    ...
                    >
                      <IoCreate className="w-4 h-4 text-indigo-600" />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      ₹{charityData?.totalDonationsReceived?.toLocaleString() || 0}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-sky-100 p-6 rounded-xl border border-blue-200 shadow-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {charityData?.totalPlatesReceived?.toLocaleString() || 0}
                    </p>
                  </div>
                </div>
              </div>
                ...
                {donations.slice(0, 5).map((donation) => (
                  <div key={donation._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    ...
                    <div className="text-right">
                      <p className="font-bold text-lg text-indigo-600">₹{donation.totalAmount}</p>
          ...
          <div className="bg-white rounded-xl shadow-md p-8">
            ...
            {sentMessages.length === 0 ? (
              <div className="text-center py-12">
                <IoHeart className="w-16 h-16 text-gray-300 mx-auto mb-4" />
                <p className="text-gray-500 text-lg">
                  No thank you messages sent yet
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            <h3 className="font-semibold text-lg text-gray-900">
                              To: {msg.user?.name || "Anonymous Donor"}
                            </h3>
                            <p className="text-sm text-gray-500">
                              {msg.user?.email}
                            </p>
                      ...
                      <div className="ml-4 flex gap-2">
                        <button
                          ...
                          className="p-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-full hover:from-blue-600 hover:to-indigo-600 transition-all shadow-lg hover:shadow-xl transform hover:scale-110"
                          title="Edit Message"
                        >
                        ...
                        <button
                          ...
                          className="p-3 bg-gradient-to-r from-red-500 to-rose-500 text-white rounded-full hover:from-red-600 hover:to-rose-600 transition-all shadow-lg hover:shadow-xl transform hover:scale-110"
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 animate-scale-in">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                {editingMessage
                  ? `Update your message to ${editingMessage.user?.name}`
                  : `Express your gratitude to ${selectedDonation?.user?.name}`}
              </p>
            </div>
            ...
            <p className="text-xs text-gray-500 mb-4">
              {thankYouMessage.length}/1000 characters
            </p>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-lg hover:from-pink-600 hover:to-rose-600 transition-all shadow-lg font-medium"
              >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 animate-scale-in">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Are you sure you want to delete this thank you message? This
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-red-500 to-rose-500 text-white rounded-lg hover:from-red-600 hover:to-rose-600 transition-all shadow-lg font-medium"
              >
                Delete Message
              </button>
            </div>
      ...
      {showProfileModal && userProfile && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 animate-scale-in max-h-[90vh] overflow-y-auto">
            <div className="text-center mb-6">
              <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-3xl font-bold">
            ...
            <form onSubmit={handleUpdateUserProfile} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg hover:from-indigo-600 hover:to-purple-600 transition-all shadow-lg font-medium"
                >
                  Save Changes
                </button>
              </div>
              ...
              <div className="text-center mb-6">
                ...
                <span
                  className={`inline-block px-3 py-1 rounded-full text-xs font-medium mt-2 ${
                    charityData.isActive
                      ? "bg-green-100 text-green-800"
                      : "bg-gray-100 text-gray-800"
                  }`}
                >
                  {charityData.isActive ? "Active" : "Inactive"}
                </span>
              </div>
