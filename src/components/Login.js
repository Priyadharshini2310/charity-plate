...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://charityplatebe.vercel.app/api/auth/login", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-pink-50 flex items-center justify-center p-4 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 -right-20 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: "1s" }}></div>
      </div>
          ...
          <div className="inline-flex items-center gap-2 mb-4">
            <a href="/" className="hover:opacity-80 transition-opacity">
              <div className="relative mb-4">
                <img src={logoicon} className="h-16 w-16 object-contain" alt="Logo Icon" />
              </div>
            </a>
            <a href="/" className="hover:opacity-80 transition-opacity">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-200 outline-none ${
                    errors.email && touched.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'
                  }`}
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-200 outline-none pr-12 ${
                    errors.password && touched.password ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'
                  }`}
                  placeholder="••••••••"
                />
                <button
