...
import logotext from "../images/NameLogo.png"; // Adjust the path as necessary
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-gray-300">
                Get the latest news about charities, impact stories, and ways to make a difference.
              </p>
            </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2025 CharityPlate, Inc. All rights reserved. Made with ❤️ for a better world.
          </p>
        </div>
      </div>
    </footer>
